	...
	<#if field.fieldType?starts_with("List") || field.fieldType?starts_with("Set") >
				<if test="${entityName}.${field.fieldName} != null and ${entityName}.${field.fieldName}.${field.fieldId.fieldName} != null" >
					...
					<if test="caseSensitive == false">
						<#if fieldCount != 1>AND </#if>UPPER(${entityName}.${keyField}) = UPPER(<#noparse>#{</#noparse>${subFieldType}.${entityName}_${keyField}})
					</if>
				</if>
	<#elseif !field.fqFieldType?starts_with("java.lang.") >
				<if test="${entityName}.${field.fieldName} != null and ${entityName}.${field.fieldName}.${field.fieldId.fieldName} != null" >
					...
					<if test="caseSensitive == false">
						<#if fieldCount != 1>AND </#if>UPPER(${entityName}.${field.fieldName}_${field.fieldId.fieldName}) = UPPER(<#noparse>#{</#noparse>${entityName}.${field.fieldName}.${field.fieldId.fieldName}})
					</if>
				</if>
	<#else>
				<if test="${entityName}.${field.fieldName} != null">
					...
					<if test="caseSensitive == false">
						<#if fieldCount != 1>AND </#if>UPPER(${entityName}.${field.fieldName}) = UPPER(<#noparse>#{</#noparse>${entityName}.${field.fieldName}})
					</if>
				</if>
	</#if>
	<#assign fieldCount = fieldCount + 1 />
...
<#list fieldList as field>
	<#if field.fieldType?starts_with("List") || field.fieldType?starts_with("Set") >
				<if test="${entityName}.${field.fieldName} != null and ${entityName}.${field.fieldName}.${field.fieldId.fieldName} != null" >
					...
					<if test="caseSensitive == false">
						<#if fieldCount != 1>AND </#if>UPPER(${entityName}.${keyField}) LIKE UPPER(<#noparse>#{</#noparse>${subFieldType}.${entityName}_${keyField}})
					</if>					
				</if>
	<#elseif !field.fqFieldType?starts_with("java.lang.") >
				<if test="${entityName}.${field.fieldName} != null and ${entityName}.${field.fieldName}.${field.fieldId.fieldName} != null" >
					...
					<if test="caseSensitive == false">
						<#if fieldCount != 1>AND </#if>UPPER(${entityName}.${field.fieldName}_${field.fieldId.fieldName}) LIKE UPPER(<#noparse>#{</#noparse>${entityName}.${field.fieldName}.${field.fieldId.fieldName}})
					</if>
				</if>
	<#else>
				<if test="${entityName}.${field.fieldName} != null">
					...
					<if test="caseSensitive == false">
						<#if fieldCount != 1>AND </#if>UPPER(${entityName}.${field.fieldName}) LIKE UPPER(<#noparse>#{</#noparse>${entityName}.${field.fieldName}})
					</if>
				</if>
	</#if>
<#assign fieldCount = fieldCount + 1 />
...
<#list fieldList as field>		
	...
	<#elseif !field.fqFieldType?starts_with("java.lang.") >
				<if test="${entityName}.${field.fieldName} != null and ${entityName}.${field.fieldName}.${field.fieldId.fieldName} != null" >
					<if test="useLike != true">
						<#if fieldCount != 1>AND </#if>${field.fieldName}_${field.fieldId.fieldName} = <#noparse>#{</#noparse>${entityName}.${field.fieldName}.${field.fieldId.fieldName}}
					</if>
					<if test="useLike == true">
						<#if fieldCount != 1>AND </#if>${field.fieldName}_${field.fieldId.fieldName} LIKE <#noparse>#{</#noparse>${entityName}.${field.fieldName}.${field.fieldId.fieldName}}
					</if>
				</if>
	<#else>
				<if test="useLike != true" >
					<#if fieldCount != 1>AND </#if>${field.fieldName} = <#noparse>#{</#noparse>${entityName}.${field.fieldName}}
				</if>
				<if test="useLike == true" >
					<#if fieldCount != 1>AND </#if>${field.fieldName} LIKE <#noparse>#{</#noparse>${entityName}.${field.fieldName}}
				</if>
	</#if>
			</if>
<#assign fieldCount = fieldCount + 1 />
